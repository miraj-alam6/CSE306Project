...
public class NoffHeader {
   ...
   */
  public static NoffHeader readHeader(OpenFile f) {
   ...
   */
  public static class NoffSegment {
       ...
       */
      public static NoffSegment readSegment(OpenFile f) {
